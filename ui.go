...
// your UI code.
func New(url, dir string, width, height int, args ...string) (UI, error) {
	if url == "" {
...
func profill(path string) (err error) {
	...
	if err != nil {
		...
		if err = ioutil.WriteFile(path+"/Default/Preferences", Preferences, 0755); err != nil {
			return
		}
	}
	return nil
